...
return { "akinsho/toggleterm.nvim",
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("n", terminalKeys[2], "<cmd>lua _HORIZONTAL_TERM2()<CR>", { noremap = true, silent = true })
    vim.api.nvim_set_keymap("i", terminalKeys[2], "<cmd>lua _HORIZONTAL_TERM2()<CR>", { noremap = true, silent = true })
    ...
    vim.api.nvim_set_keymap("n", terminalKeys[3], "<cmd>lua _HORIZONTAL_TERM3()<CR>", { noremap = true, silent = true })
    vim.api.nvim_set_keymap("i", terminalKeys[3], "<cmd>lua _HORIZONTAL_TERM3()<CR>", { noremap = true, silent = true })
